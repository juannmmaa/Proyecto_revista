...
class usuarios_model extends CI_Model 
{
   ...
   public function modificar_usuario($datos=array(),$pk)
    ...
    public function modificar_articulo($datos=array(),$pk)
    {
      ...
      { 
        /*
        -todo esto esta bien: esta recibiendo el rut pasandolo a entero y sacandole el digito verificador que se ingresa
        - falta calcular el digito verificador con el rut sin digito verificador para compararlo con el ingresado y retornar un bool
        ...
        <?php
        $var=(int) $rut;
        $digito = $var%10; //obtengo el digito verificador
        ...
        $var = $var - $digito; 
        $var = $var/10;
        echo $var; //comprobar si es el rut sin digito verificador
        ?>
        <br/>
        <?php
        */
